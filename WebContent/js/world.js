var config = {
	...
	上海博物馆: function() {
		goTo(31.4500, 121.5833);

		window.setTimeout("open('上海博物馆.html')",2850)
	},
	故宫博物馆: function() {
		goTo(39.4500, 116.5833);

		window.setTimeout("open('故宫博物馆.html')",2850)
	},
	台北故宫博物馆: function() {
		goTo(25.0373, 121.5635);

		window.setTimeout("open('台北故宫博物馆.html')",2850)
	},
	大英博物馆: function() {
		goTo(54.7024, -3.2768);

		window.setTimeout("open('大英博物馆.html')",2850)
	},
	卢浮宫: function() {
		goTo(46.6034, 1.8882);

		window.setTimeout("open('卢浮宫.html')",2850)
	}
...
function init(ref) {
	...
	gui.add(config, '上海博物馆');
	gui.add(config, '故宫博物馆');
	gui.add(config, '台北故宫博物馆');
	gui.add(config, '大英博物馆');
	gui.add(config, '卢浮宫');
